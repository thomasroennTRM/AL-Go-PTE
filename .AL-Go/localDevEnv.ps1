...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/thomasroennTRM/AL-Go/Actions/7d1596be27f03240853f7a26f2fe1ac4a5ba4ddf/Environment.Packages.proj' -folder $tmpFolder | Out-Null
